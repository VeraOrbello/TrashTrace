document.addEventListener('DOMContentLoaded', function(){
    ...
    function renderReports(items){
        ...
        items.forEach(r => {
            ...
            const name = r.resident_name ? r.resident_name : 'Anonymous';
                ...
                <div class="report-row">
                    ...
                    <div class="report-content">
                        ...
                        <div class="report-badges">
                            ...
                            <span class="badge">Barangay: ${escapeHtml(r.resident_barangay || 'N/A')}</span>
                            <span class="badge">City: ${escapeHtml(r.resident_city || 'N/A')}</span>
                        </div>
                        ...
                        <div class="report-panel" style="display:none;">
                            <div style="margin-top:8px;">
                                <label>Message to resident</label>
    ...
    function applyFilters(){
        ...
        if(q){
            results = results.filter(r => {
                const hay = ((r.resident_name||'') + ' ' + (r.description||'') + ' ' + (r.address||'') + ' ' + (r.location||'')).toLowerCase();
