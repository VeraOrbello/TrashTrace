...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <p>TrashTrace helps barangays schedule trash pickups efficiently and keeps residents informed about collection schedules and any changes in real-time.</p>
        ...
        <div class="container">
            ...
            <div class="features-grid">
                ...
                <div class="feature-card">
                    ...
                    <p>Residents receive timely reminders about pickup dates via their preferred notification channel.</p>
                </div>
                <div class="feature-card">
                    <div class="feature-icon">🔄</div>
        ...
        <div class="container">
            ...
            <div style="max-width: 800px; margin: 0 auto;">
                <p style="text-align: center; margin-bottom: 2rem;">
                    In many barangays, residents face the problem of trash piling up on streets when collectors don't show up on scheduled days. This creates unsanitary conditions and sometimes blocks streets.
                </p>
                <p style="text-align: center;">
                    TrashTrace solves this by providing accurate scheduling and real-time updates, ensuring neighborhoods stay clean and residents are always informed.
                </p>
            </div>
        </div>
    </section>
