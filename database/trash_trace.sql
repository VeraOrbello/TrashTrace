...
CREATE TABLE `users_backup_2024` (
  ...
  `address` text DEFAULT NULL,
  `password` varchar(255) NOT NULL,
  `user_type` enum('resident','barangay_worker_pending','barangay_worker') DEFAULT 'resident',
  `notification_channel` enum('SMS','Email','Both') DEFAULT 'Email',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'Mary Grace', 'vmtherese7@gmail.com', '09764717026', 'CEBU CITY', 'Talamban', '1', '1', '$2y$10$gXrC9wFwLnRCX.MqqAN66Oy/tfQ0pFKL.R9s2o0yffK6cUoflPt7C', 'resident', 'Email', '2025-12-16 15:54:54'),
(2, 'Barangay Admin', 'admin@example.com', NULL, 'Your City', 'Your Barangay', NULL, 'Barangay Hall', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'barangay_worker', 'Email', '2025-12-18 08:58:34');
